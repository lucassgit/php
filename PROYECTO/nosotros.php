                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="text-slid-box">
                        <div id="offer-box" class="carouselTicker">
                            <ul class="offer-box">
                                <li>
                                    <i class="fab fa-opencart"></i> 20% off En Burgers
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> 50% off En Postres
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> Off 10%! En Nuggets
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> Off 50%! Hacé tu pedido
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> Off 10%! En Bebidas
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> 30% off on Vegetables
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> 20% off  En Promos
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> Off 50%! Para clientes nuevos 
                                </li>
                            </ul>
                        </div>
                    </div>
