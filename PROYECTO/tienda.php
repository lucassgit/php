                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="custom-select-box">
                        <select id="basic" class="selectpicker show-tick form-control" data-placeholder="$ USD">
							<option>$PESOARG</option>
							<option>$ USD</option>
						</select>
                    </div>
                    <div class="right-phone-box">
                        <p>Contactanos :- <a href="#"> +1126655444</a></p>
                    </div>
                    <div class="our-link">
                        <ul>
                    ...
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
								...
								<li><a href="shop-detail.html">Productos</a></li>
                                <li><a href="cart.html">Carrito</a></li>
                                <li><a href="checkout.html">Clientes</a></li>
                        ...
                        <div class="product-item-filter row">
                            <div class="col-12 col-sm-8 text-center text-sm-left">
                                <div class="toolbar-sorter-right">
									...
									<option value="2">Mayor precio → Menor precio</option>
									<option value="3">Menor precio → Mayor precio</option>
