...
if (file_exists("archivo.txt")) {
    //Se almacena el contenido en jsonClientes..
    $jsonClientes = file_get_contents("archivo.txt");

    //Convertir jsonClientes en un array..
    $aClientes = json_decode($jsonClientes, true);
} else {
    //Se crea aClientes inicializado como un array vacio..
    $aClientes = array();
}
...
if ($_POST) {
    ...
    //Almacenar el string jsonClientes..
    file_put_contents("archivo.txt", $jsonClientes);
}

if (isset($_GET["do"]) && $_GET["do"] == "eliminar") {
    //Eliminar del array aClientes..
    unset($aClientes[$pos]);

    //Convertir el arraya jsonClientes..
    $jsonClientes = json_encode($aClientes);
