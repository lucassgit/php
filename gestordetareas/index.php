...
if (file_exists("archivo.txt")) {
    //Si el archivo existe se cargan las tareas en aTareas..
    $strJson = file_get_contents("archivo.txt");
    $aTareas = json_decode($strJson, true);
} else {
    //Si el archivo no existe es porque no hay tareas cargadas..
    $aTareas = array();
}
...
//Opcional: $id = isset($_GET["id"]) && $_GET["id"] >= 0 ? $_GET["id"] : "";
