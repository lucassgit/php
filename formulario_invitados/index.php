...
//Si existe el archivo invitados se carga en una variable del tipo array..
//los DNI permitidos
if (file_exists("invitados.txt")) {
    $archivo = fopen("invitados.txt", "r");
    $aDocumentos = fgetcsv($archivo, 0, ",");
} else {
    //De lo contrario el array queda vacio..
    $aDocumentos = array();
}
...
if ($_POST) {
    if (isset($_POST["btnProcesar"])) {
        ...
        //Si el DNI se encuentra en la lista aparece..
            ...
            <div class="col-6">
                <form method="POST" action="">
                    <div class="row">
                        <div class="col-12">
                            <p>Ingrese el DNI:
                            <p><input type="text" name="txtDocumento" class="form-control">
